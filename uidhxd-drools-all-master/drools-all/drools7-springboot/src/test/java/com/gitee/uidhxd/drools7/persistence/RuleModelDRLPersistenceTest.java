  ...
  @Test
    public void testMutiClass() {
      ...
      try {
          ...
          final SingleFieldConstraint pfield = new SingleFieldConstraint();
          pfield.setFieldName("type");
          pfield.setOperator("==");
          pfield.setValue("CHEDDAR");
          pfield.setFieldType(DataType.TYPE_STRING);
          pfield.setConstraintValueType(BaseSingleFieldConstraint.TYPE_ENUM);
          p.addConstraint(pfield);
          
          final SingleFieldConstraint pfield2 = new SingleFieldConstraint();   
          pfield2.setFieldName("type2");
          pfield2.setOperator("==");
          pfield2.setValue("CHEDDAR2");
          pfield2.setFieldType(DataType.TYPE_STRING);
          pfield2.setConstraintValueType(BaseSingleFieldConstraint.TYPE_ENUM);
          p.addConstraint(pfield2);
          
          FactPattern q = new FactPattern("Question");
          q.setBoundName("$q");
...
//          
    ...
    public void testNotNull() {
        ...
        SingleFieldConstraint constraint1 = new SingleFieldConstraint("Customer",
                                                                      "contact",
                                                                      "Contact",
                                                                      null);
        ...
        SingleFieldConstraint constraint2 = new SingleFieldConstraint("Customer",
                                                                      "contact",
                                                                      "Contact",
                                                                      null);
        factPattern.addConstraint(constraint2);

        SingleFieldConstraint constraint3 = new SingleFieldConstraint("Contact",
                                                                      "tel1",
                                                                      "Integer",
                                                                      constraint2);
    ...
    @Test
    public void testCompositeConstraints333() {
        RuleModel m = new RuleModel();
        m.name = "with composite";
        ...
        X.setFieldName("(age-30)");
        X.setFieldType(DataType.TYPE_NUMERIC_INTEGER);
        X.setConstraintValueType(SingleFieldConstraint.TYPE_LITERAL);
		X.setOperator(">=");		
		X.setValue("20"); 

        final SingleFieldConstraint X2 = new SingleFieldConstraint();
        X2.setFieldName("age");
        X2.setFieldType(DataType.TYPE_NUMERIC_INTEGER);
        X2.setConstraintValueType(SingleFieldConstraint.TYPE_LITERAL);
        X2.setOperator("<=");		
        X2.setValue("50"); 
        comp.addConstraint(X2);
        
        CompositeFieldConstraint comp1 = new CompositeFieldConstraint();
        comp1.setCompositeJunctionType(CompositeFieldConstraint.COMPOSITE_TYPE_AND);
        comp1.addConstraint(comp);
        
        final SingleFieldConstraint X3 = new SingleFieldConstraint();
        X3.setFieldName("location");
        X3.setFieldType(DataType.TYPE_STRING);
        X3.setConstraintValueType(SingleFieldConstraint.TYPE_LITERAL);
        X3.setOperator("==");		
        X3.setValue("浦东"); 
        comp1.addConstraint(X3);
        
        CompositeFieldConstraint comp2 = new CompositeFieldConstraint();
        comp2.setCompositeJunctionType(CompositeFieldConstraint.COMPOSITE_TYPE_OR);
        comp2.addConstraint(comp1);
        
        final SingleFieldConstraint X4 = new SingleFieldConstraint();
        X4.setFieldName("sex");
        X4.setFieldType(DataType.TYPE_STRING);
        X4.setConstraintValueType(SingleFieldConstraint.TYPE_LITERAL);
        X4.setOperator("==");		
        X4.setValue("男"); 
        comp2.addConstraint(X4);
        
       
		/*
		 * X.setConnectives(new ConnectiveConstraint[1]); X.getConnectives()[0] = new
		 * ConnectiveConstraint();
		 * X.getConnectives()[0].setConstraintValueType(ConnectiveConstraint.
		 * TYPE_RET_VALUE); X.getConnectives()[0].setFieldType(DataType.TYPE_STRING);
		 * X.getConnectives()[0].setOperator("+");
		 * X.getConnectives()[0].setValue("bar");
		 */
        comp.addConstraint(X);
        p1.addConstraint(comp2);
